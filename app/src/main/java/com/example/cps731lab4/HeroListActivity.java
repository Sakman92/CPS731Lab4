...
import com.example.cps731lab4.dummy.DummyContent;
...
public class HeroListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View recyclerView = findViewById(R.id.hero_list);
    ...
    public static class SimpleItemRecyclerViewAdapter
        ...
        private final HeroListActivity mParentActivity;
        ...
        private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mTwoPane) {
                    ...
                    arguments.putString(HeroDetailFragment.ARG_ITEM_ID, item.id);
                    ...
                    intent.putExtra(HeroDetailFragment.ARG_ITEM_ID, item.id);
        ...
        SimpleItemRecyclerViewAdapter(HeroListActivity parent,
        ...
        class ViewHolder extends RecyclerView.ViewHolder {
            ...
            ViewHolder(View view) {
                super(view);
                mTitle = (TextView) view.findViewById(R.id.heroTitle);
